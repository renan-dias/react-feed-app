...
function CreatePostBox() {
  ...
  return (
    <div className="create-post-box glassmorphism-effect"> {/* Adicionada classe glassmorphism */}
        ...
        <Form onSubmit={handlePostSubmit} className="w-100">
          <Form.Group controlId="postTextArea">
            <Form.Control
              ...
              disabled={isPosting}
              style={{ backgroundColor: 'transparent', color: '#333' }} // Para vazar o glassmorphism
            />
          </Form.Group>
          <div className="create-post-actions mt-2">
            <div className="icons">
              <BsCardImage size={22} onClick={() => alert('Upload de imagem ainda não implementado.')} style={{ color: '#007BFF' }}/>
              <BsEmojiSmile size={22} onClick={() => alert('Seletor de emoji ainda não implementado.')} style={{ color: '#007BFF' }}/>
            </div>
            <Button 
              variant="primary" 
              type="submit" 
