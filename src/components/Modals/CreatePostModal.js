...
function CreatePostModal({ show, handleClose }) {
  ...
  return (
    ...
    >
      <Modal.Header closeButton style={{ borderBottom: 'none' }}> {/* Removendo borda padrão para melhor estética com glassmorphism */}
        <Modal.Title>Criar nova postagem</Modal.Title>
      </Modal.Header>
      <Modal.Body style={{ paddingTop: '0.5rem' }}> {/* Ajuste de padding se a borda do header foi removida */}
        ...
        <Form onSubmit={handlePostSubmit}>
          <Form.Group controlId="postModalTextArea">
            <Form.Control
              ...
              style={{ 
                ...
                resize: 'none', 
                paddingLeft: 0, 
                backgroundColor: 'transparent', /* Para o glassmorphism do modal vazar */
                color: '#333' /* Garantir cor do texto legível */
              }}
            />
          </Form.Group>
          ...
          <div className="d-flex justify-content-between align-items-center mt-3 pt-3 border-top" style={{ borderColor: 'rgba(255,255,255,0.2)'}}> {/* Borda mais clara */}
            <div>
              ...
              <Button 
                ...
                className="me-2"
                style={{ backgroundColor: 'rgba(255,255,255,0.5)', border: 'none'}} /* Botão levemente transparente */
              >
                <BsCardImage size={22} style={{color: "#007BFF"}}/> {/* Ícone azul para combinar com tema */}
              </Button>
